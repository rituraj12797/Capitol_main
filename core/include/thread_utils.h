...
// THIS CODE IS WRITTEN WITH HELP OF AGENTIC AI - AS I ALREADY WROTE THIS PIECE OF CODE EARLIER FOR WINDOWS I DECIDED NOT TO DO THE MANUAL WORK AGAIN FROM SCRATCH
